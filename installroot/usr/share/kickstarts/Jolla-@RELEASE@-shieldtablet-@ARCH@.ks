# DisplayName: Jolla shieldtablet/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: shieldtablet
# DeviceVariant: shieldtablet
...
repo --name=adaptation-community-common-shieldtablet-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration shieldtablet
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/shieldtablet
